...
/*   Updated: 2024/01/16 22:14:50 by rde-mour         ###   ########.org.br   */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc < 2 || argc > 2 || argv[1] == (void *)0)
		ft_error(0, "Error: No map informed. ./fdf <map name>");
	map = fdf_start_map();
	...
	start_camera(map);
	print_matrix(&map);
	mlx_key_hook(map -> mlx, fdf_close, map);
